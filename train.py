...
wdir = os.sep + 'content' + os.sep + 'Yolov3-Custom-Object-Detection' + os.sep +  'weights' + os.sep  # weights dir
last = wdir + 'last.pt'
best = wdir + 'best.pt'
...
def train(hyp):
    ...
    hyp['cls'] *= nc / 80  # update sku-tuned hyp['cls'] to current dataset
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if not opt.notest or final_epoch:  # Calculate mAP
            is_sku = any([x in data for x in ['SKU.data']]) and model.nc == 80
            results, maps = test.test(cfg,
                                      data,
                                      batch_size=batch_size,
                                      imgsz=imgsz_test,
                                      model=ema.ema,
                                      save_json=final_epoch and is_sku,
                                      single_cls=opt.single_cls,
